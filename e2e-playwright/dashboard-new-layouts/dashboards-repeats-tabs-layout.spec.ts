...
test.describe('Repeats - Dashboard tabs layout', () => {
  ...
  test('can view panels in repeated tab', async ({ dashboardPage, selectors, page }) => {
    ...
    await dashboardPage.getByGrafanaSelector(selectors.components.DashboardRow.title('Row 2')).scrollIntoViewIfNeeded();
    await dashboardPage
