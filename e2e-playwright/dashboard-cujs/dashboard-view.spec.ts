...
test.describe('Dashboard view CUJs', () => {
  test('View a dashboard', async ({ page, gotoDashboardPage, selectors }) => {
    ...
    await test.step('4.Set time range for the dashboard', async () => {
      ...
      await test.step('4.2.Set absolute time range', async () => {
        await timePickerButton.click();
        await dashboardPage.getByGrafanaSelector(selectors.components.TimePicker.fromField).fill('2024-01-01 00:00:00');
      ...
      await test.step('4.3.Change time zone', async () => {
        await timePickerButton.click();
        await dashboardPage.getByGrafanaSelector(selectors.components.TimeZonePicker.changeTimeSettingsButton).click();
      ...
      await test.step('4.4.Navigate time range', async () => {
        ...
        await dashboardPage.getByGrafanaSelector(selectors.components.TimePicker.fromField).fill('2024-01-01 08:30:00');
