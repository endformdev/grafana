...
test.describe('Snapshots', () => {
  test('Create a snapshot dashboard', async ({ page, gotoDashboardPage, selectors }) => {
    ...
    // Publish snapshot
    await dashboardPage.getByGrafanaSelector(selectors.pages.ShareDashboardModal.SnapshotScene.PublishSnapshot).click();
    ...
    const urlInput = dashboardPage.getByGrafanaSelector(selectors.pages.ShareDashboardModal.SnapshotScene.CopyUrlInput);
