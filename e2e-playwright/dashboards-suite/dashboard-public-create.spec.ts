...
test.describe('Public dashboards', () => {
  test('Create, open and disable a public dashboard', async ({ page, gotoDashboardPage, selectors, request }) => {
    ...
    await dashboardPage.getByGrafanaSelector(selectors.pages.ShareDashboardModal.PublicDashboard.CreateButton).click();
    ...
    copyUrlInput = dashboardPage.getByGrafanaSelector(selectors.pages.ShareDashboardModal.PublicDashboard.CopyUrlInput);
