...
test.describe('Variables - Load options from Url', () => {
  test('default options should be correct', async ({ page, gotoDashboardPage, selectors }) => {
    ...
    // Check dropdown has 10 options
    const secondDropdownOptions = dashboardPage.getByGrafanaSelector(selectors.components.Select.option).locator('..');
