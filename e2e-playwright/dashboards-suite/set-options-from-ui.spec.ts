...
test.describe('Variables - Set options from ui', () => {
  test('clicking a value that is not part of dependents options should change these to All', async ({
    ...
    await expect(
      dashboardPage.getByGrafanaSelector(selectors.pages.Dashboard.SubMenu.submenuItemValueDropDownValueLinkTexts('B'))
    ).toBeVisible();
